class Ghost {
    constructor(id, position, canvas) {
        ...
        this.image.src = "assets/css/teron/img/ghost_banane.png";
        this.image.width = 40;
    ...
    select(value) {
        if (value) {
            this.image.src = "assets/css/teron/img/selected_banane.png";
        } else {
            this.image.src = "assets/css/teron/img/ghost_banane.png";
        }
        this.selected = value;
...
class Teron {
    constructor(pX, pY) {
        this.image = new Image();
        this.image.src = "assets/css/teron/img/teron.png";
        this.image.width = 50;
